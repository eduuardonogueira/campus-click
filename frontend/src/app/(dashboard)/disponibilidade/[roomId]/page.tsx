      ...
      <main className="p-10 flex-1">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              id="add-btn"
              className="px-6 py-2 bg-black text-white rounded-md hover:bg-gray-800 text-sm cursor-pointer"
        ...
        {availabilities.length === 0 ? (
          <div className="flex flex-col items-center justify-center text-center py-20 w-full border rounded-lg border-gray-300">
            ...
            <button
              ...
              className="px-6 py-2 bg-black text-white text-sm rounded-md hover:bg-gray-800 cursor-pointer"
            >
              Criar agora!
            </button>
          </div>
